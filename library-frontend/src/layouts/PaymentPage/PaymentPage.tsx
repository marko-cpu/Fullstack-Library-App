...
export const PaymentPage = () => { 
    ...
    return(
        <div className='container'>
            {fees > 0 && <div className='card mt-3 bok'>
                <h5 className='card-header'>Fees pending: <span className='text-danger'>${fees}</span></h5>
                <div className='card-body'>
                    <h5 className='card-title mb-3'>Credit Card</h5>
                    <CardElement id='card-element' />
                    <button disabled={submitDisabled} type='button' className='btn btn-md pag colortext-white mt-3' 
                        onClick={checkout}>
                        Pay fees
                    </button>
                </div>
            ...
            {fees === 0 && 
                <div className='mt-4'>
                    ...
                    <Link type='button' className='btn pag color btnw' to='search'>
                        Explore top books
                    </Link>
                </div>
            }
            {submitDisabled && <SpinerLoading/>}
        </div>
    );
}