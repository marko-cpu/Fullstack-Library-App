              ...
              <div className="mt-3">
                ...
                <div className="list-group mt-3">
                  <button
                    ...
                    data-bs-dismiss="modal"
                    className="list-group-item list-group-item-action pag pagcol"
                    aria-current="true"
                  >
                    Return Book
                  </button>
                  ...
                  (event) => event.preventDefault()
                    ...
                    className={
                      props.shelfCurrentLoan.daysLeft < 0
                        ? "list-group-item list-group-item-action inactivateLink pag pagcol"
                        : "list-group-item list-group-item-action pag pagcol"
                    }
                  >
                    {props.shelfCurrentLoan.daysLeft < 0
