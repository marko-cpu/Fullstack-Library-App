...
export const AdminMessage: React.FC<{ message: MessageModel,
 submitResponseToQuestion: any}> = (props, key) => {
    ...
    return (<div key={props.message.id}>
        <div className="card mt-2 shadow p-3 bg-body rounded bg">
            ...
            <div>
                ...
                <form action="PUT">
                    ...
                    <div>
                        <button type="button" className="btn pag color mt-3" onClick={submitBtn}>Submit Response</button>
                    </div>
                </form>
            </div>
        </div>
