...
export const ChangeQuantityOfBook: React.FC<{ book: BookModel, deleteBook: any }> = (props, key) => {
    ...
    async function increaseQuantity() {
        ...
        const quantiyUpdateResponse = await fetch(url, requestOptions);
        if(!quantiyUpdateResponse.ok) {
        ...
        <div className="row g-0">
            <div className="col-md-2">
                <div className="d-none d-lg-block">
                    ...
                    :
                    <img src={require('./../../../Images/BooksImages/book.jpg')} width='123' height='196' alt="Book"/>
                }
            ...
            <div className="col-md-6">
                <div className="card-body">
                    ...
                    <button className="m-1 btn btn-md btn-success text-white" onClick={increaseQuantity}>Add Quantity</button>
                    <button className="m-1 btn btn-md btn-danger" onClick={decreaseQuantity}>Decrease Quantity</button>
